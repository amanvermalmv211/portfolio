  ...
  return (
    <>
      <section className={`flex flex-col items-center p-4 ${props.mode === "light" ? "text-gray-700 bg-gray-100" : "text-white bg-gray-900"} scroll-mt-[1500px]`} id="myEducation">
        <Helmet>
          <title>Projects | Aman's Portfolio 24x7</title>
...

          {
            projects.map((project, idx) => {
              return <div key={idx} className={`border-t-4 border-b-4 rounded-xl border-double p-2 h-80 shadow-lg text-center w-64 ${props.mode === "light" ? "border-orange-500 bg-white hover:shadow-gray-400" : "border-blue-600 bg-blue-950 hover:shadow-blue-900"} select-none relative`} data-aos={`${idx % 2 !== 0 ? "flip-left" : "flip-right"}`} data-aos-duration="800">
                ...
                <div className={`absolute bottom-2 left-0 w-full ${props.mode === "light" ? "text-orange-500" : "text-blue-500"} underline flex items-center justify-around text-sm`}>
